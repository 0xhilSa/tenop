...
- [ ] Buffer doesn't know that `pointer` is a vector or a scalar for that issue we need to set some flags or create var that would store a string `v`(vector), or `s`(scalar)
- [ ] impl of LazyBuffer yet to be impl
